...
echo "[pragma_lite_full_encode_wrapper] shard=${SHARD_INDEX} stage=encode start" >&2
...
echo "[pragma_lite_full_encode_wrapper] shard=${SHARD_INDEX} stage=manifest start" >&2
...
echo "[pragma_lite_full_encode_wrapper] shard=${SHARD_INDEX} stage=done" >&2
