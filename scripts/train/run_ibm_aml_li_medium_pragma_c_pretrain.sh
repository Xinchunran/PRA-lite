...
DATALOADER_DYNAMIC_BATCHING="${DATALOADER_DYNAMIC_BATCHING:-1}"
DATALOADER_TOKEN_BUDGET="${DATALOADER_TOKEN_BUDGET:-32768}"
DATALOADER_MAX_BATCH_SIZE="${DATALOADER_MAX_BATCH_SIZE:-16}"
...
export DATALOADER_DYNAMIC_BATCHING DATALOADER_TOKEN_BUDGET DATALOADER_MAX_BATCH_SIZE
...
echo "[pragma_c_pretrain] DATALOADER_DYNAMIC_BATCHING=${DATALOADER_DYNAMIC_BATCHING}"
echo "[pragma_c_pretrain] DATALOADER_TOKEN_BUDGET=${DATALOADER_TOKEN_BUDGET}"
echo "[pragma_c_pretrain] DATALOADER_MAX_BATCH_SIZE=${DATALOADER_MAX_BATCH_SIZE}"
